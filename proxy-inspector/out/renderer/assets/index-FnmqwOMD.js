...
function useFileData() {
  ...
  const [aggregates, setAggregates] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    ...
    const cleanupNewEvents = window.api.onNewEvents((update) => {
  ...
  const openFile = reactExports.useCallback(async () => {
    setIsLoading(true);
...
function Toolbar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "toolbar", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "toolbar-stats", children: aggregates && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "toolbar-stat", children: [
        "Interactions: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "toolbar-stat-value", children: aggregates.totalInteractions })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "toolbar-stat", children: [
        "Tokens: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "toolbar-stat-value", children: formatTokens$3(aggregates.totalTokens) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "toolbar-stat", children: [
        "Tools: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "toolbar-stat-value", children: aggregates.totalToolCalls })
      ] })
    ] }) }),
...
function StatusIcon({ status }) {
  switch (status) {
    case "complete":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "interaction-card-status status-complete", children: "✓" });
    case "in-progress":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "interaction-card-status status-in-progress status-spinner", children: "◠" });
    case "error":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "interaction-card-status status-error", children: "✗" });
  }
}
function InteractionCard({ summary, isSelected, onClick }) {
  const classes = [
    "interaction-card",
    isSelected ? "selected" : "",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "interaction-card-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "interaction-card-index", children: [
            "#",
            summary.index
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "interaction-card-message", title: summary.userMessage, children: summary.userMessage || "(empty message)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatusIcon, { status: summary.status })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "interaction-card-meta", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatTime(summary.timestamp) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatDuration$2(summary.durationMs) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            formatTokens$2(summary.totalTokens),
            " tokens"
          ] })
        ] }),
        (summary.roundTripCount > 0 || summary.toolCalls.length > 0 || summary.hasErrors) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "interaction-card-badges", children: [
          summary.roundTripCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "badge badge-rt", children: [
            summary.roundTripCount,
            " RT"
          ] }),
          summary.toolCalls.length > 0 && summary.toolCalls.map((tool, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge badge-tool", children: tool }, `${tool}-${idx}`)),
          summary.hasErrors && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge badge-error", children: "error" })
        ] })
      ]
    }
  );
...
function InteractionList({
  ...
  const wasAtBottomRef = reactExports.useRef(true);
  reactExports.useEffect(() => {
  ...
  const handleKeyDown = reactExports.useCallback(
    (e) => {
      ...
      const currentIdx = selectedId ? interactions.findIndex((i) => i.id === selectedId) : -1;
      let nextIdx = null;
      switch (e.key) {
        case "ArrowDown":
          e.preventDefault();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        interactions.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          padding: 16,
          color: "#6c7086",
          textAlign: "center",
          fontSize: 13
        }, children: "No interactions loaded. Open a file to begin." }),
        interactions.map((summary) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          InteractionCard,
          {
            summary,
...
function useDetail(interactionId) {
...
function CollapsibleSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collapsible-header", onClick: () => setIsOpen((o) => !o), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `collapsible-chevron ${isOpen ? "open" : ""}`, children: "▶" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "collapsible-title", children: title }),
      badge && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "collapsible-badge", children: badge })
    ] }),
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { paddingTop: 4 }, children })
  ] });
}
...
function JsonNode({
  ...
  if (value === null) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      keyName !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "json-key", children: [
          '"',
          keyName,
          '"'
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-null", children: "null" })
    ] });
  }
  if (typeof value === "boolean") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-boolean", children: String(value) })
    ] });
  }
  if (typeof value === "number") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-number", children: value })
    ] });
  }
  if (typeof value === "string") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(StringValue, { value, keyName });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-string", children: String(value) });
}
function StringValue({ value, keyName }) {
  const [showFull, setShowFull] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "json-string", children: [
      '"',
      display,
      '"'
    ] }),
    isTruncated && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-string", children: "..." }),
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "json-show-more", onClick: () => setShowFull(true), children: [
        "Show more (",
        value.length,
        " chars)"
      ] })
    ] }),
    showFull && value.length > MAX_STRING_LENGTH && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "json-show-more", onClick: () => setShowFull(false), children: "Show less" })
    ] })
  ] });
}
function ObjectNode({
  ...
  if (keys.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-bracket", children: "{}" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "span",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-bracket", children: "{" }),
          !expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "json-collapsed-indicator", children: [
            " ",
            keys.length,
            " keys... "
          ] }),
          !expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-bracket", children: "}" })
        ]
      }
    ),
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "json-node", children: keys.map((k, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        JsonNode,
        {
          value: value[k],
      ...
      i < keys.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-bracket", children: "," })
    ] }, k)) }),
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-bracket", children: "}" })
  ] });
}
function ArrayNode({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "json-node", children: value.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        JsonNode,
        {
          value: item,
      ...
      i < value.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-bracket", children: "," })
    ] }, i)) }),
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "json-bracket", children: "]" })
  ] });
}
...
function InteractionStartBody({ payload }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-card-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Session ID" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-value", style: { fontFamily: "var(--font-mono)", fontSize: 11 }, children: String(payload.sessionId ?? "") })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "User Message" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-text-preview selectable", children: String(payload.userMessage ?? "") })
    ] })
  ] });
}
function LlmRequestBody({ payload }) {
  const model = String(payload.model ?? "");
  const contentsCount = payload.contentsCount;
  const toolNames = payload.toolNames ?? [];
  const systemText = payload.systemInstructionText;
  const toolDeclarations = payload.toolDeclarations;
  const contents = payload.contents;
  const generationConfig = payload.generationConfig;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-card-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Model" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-model-name", children: model })
    ] }),
    contentsCount !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleSection, { title: "Conversation Contents", badge: `${contentsCount} items`, children: contents && Array.isArray(contents) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: contents.map((item, idx) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `chat-bubble role-${role}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "chat-bubble-role", children: role }),
        text
      ] }, idx);
    }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-dim)" }, children: "No contents data" }) }) }),
    systemText && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleSection, { title: "System Instruction", badge: `${systemText.length} chars`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { style: {
    ...
    }, className: "selectable", children: systemText }) }) }),
    toolNames.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section-label", children: [
        "Tools (",
        toolNames.length,
        ")"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tool-chip-list", children: toolNames.map((name) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tool-chip", children: name }, name)) })
    ] }),
    toolDeclarations && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleSection, { title: "Tool Declarations", children: /* @__PURE__ */ jsxRuntimeExports.jsx(JsonViewer, { data: toolDeclarations }) }) }),
    generationConfig && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleSection, { title: "Generation Config", children: /* @__PURE__ */ jsxRuntimeExports.jsx(JsonViewer, { data: generationConfig }) }) })
  ] });
}
function LlmResponseBody({ payload }) {
  const content = payload.content;
  const usage = payload.usageMetadata;
  const durationMs = payload.durationMs;
  const streamed = payload.streamed;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-card-body", children: [
    functionCall && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Function Call" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-tool-name", children: functionCall.name }),
      functionCall.args && Object.keys(functionCall.args).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(JsonViewer, { data: functionCall.args, label: "Arguments" }) })
    ] }),
    responseText && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Response" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-text-preview selectable", children: responseText })
    ] }),
    usage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Tokens" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "token-summary", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "token-badge", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-label", children: "prompt" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-value", children: formatTokens$1(usage.promptTokenCount ?? 0) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "token-badge", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-label", children: "completion" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-value", children: formatTokens$1(usage.candidatesTokenCount ?? 0) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "token-badge", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-label", children: "total" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-value", children: formatTokens$1(usage.totalTokenCount ?? 0) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 16, flexWrap: "wrap", alignItems: "center" }, children: [
      durationMs !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "duration-text", children: formatDuration$1(durationMs) }),
      streamed !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "streaming-info", children: streamed ? `Streamed (${chunkCount ?? "?"} chunks)` : "Not streamed" }),
      finishReason && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "streaming-info", children: [
        "Finish: ",
        finishReason
      ] })
    ] }) })
...
function ToolStartBody({ payload }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-card-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Tool" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-tool-name", children: String(payload.toolName ?? "") })
    ] }),
    payload.functionCallId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Function Call ID" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--text-dim)" }, children: String(payload.functionCallId) })
    ] }),
    payload.args && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleSection, { title: "Arguments", defaultOpen: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(JsonViewer, { data: payload.args }) }) })
  ] });
}
function ToolResultBody({ payload }) {
  const resultKeys = payload.resultKeys ?? [];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-card-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Tool" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-tool-name", children: String(payload.toolName ?? "") })
    ] }),
    payload.durationMs !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Duration" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "duration-text", children: formatDuration$1(payload.durationMs) })
    ] }),
    resultKeys.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Result Keys" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { style: { paddingLeft: 16, fontSize: 12, color: "var(--text-secondary)" }, children: resultKeys.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: k }, k)) })
    ] })
  ] });
}
function ErrorBody({ payload, type }) {
  const message = String(payload.errorMessage ?? payload.error ?? "Unknown error");
  const code = payload.errorCode;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-card-body", children: [
    type === "tool" && payload.toolName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Tool" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-tool-name", children: String(payload.toolName) })
    ] }),
    code && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Error Code" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontFamily: "var(--font-mono)", fontSize: 12, color: "var(--error)" }, children: code })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-error-message", children: message }) })
  ] });
}
function InteractionEndBody({ payload }) {
  const rtCount = payload.roundTripCount;
  const totalTokens = payload.totalTokens;
  const promptTokens = payload.totalPromptTokens;
  const completionTokens = payload.totalCompletionTokens;
  const durationMs = payload.durationMs;
  const toolCalls = payload.toolCalls ?? [];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-card-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "end-summary-grid", children: [
      rtCount !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "end-summary-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "end-summary-item-label", children: "Round Trips" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "end-summary-item-value", children: rtCount })
      ] }),
      totalTokens !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "end-summary-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "end-summary-item-label", children: "Total Tokens" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "end-summary-item-value", children: formatTokens$1(totalTokens) })
      ] }),
      durationMs !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "end-summary-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "end-summary-item-label", children: "Duration" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "end-summary-item-value", children: formatDuration$1(durationMs) })
      ] })
    ] }),
    (promptTokens !== void 0 || completionTokens !== void 0) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section", style: { marginTop: "var(--spacing-sm)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "token-summary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "token-badge", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-label", children: "prompt" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-value", children: formatTokens$1(promptTokens ?? 0) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "token-badge", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-label", children: "completion" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "token-badge-value", children: formatTokens$1(completionTokens ?? 0) })
      ] })
    ] }) }),
    toolCalls.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-section", style: { marginTop: "var(--spacing-sm)" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-section-label", children: "Tool Calls" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tool-chip-list", children: toolCalls.map((name, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tool-chip", children: name }, `${name}-${i}`)) })
    ] })
  ] });
}
...
function EventTimeline({ events }) {
  if (events.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-dim)" }, children: "No events" });
  }
  const firstTimestamp = new Date(events[0].timestamp).getTime();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-timeline", children: events.map((event) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      `${event.interactionId}-${event.lineIndex}`
    );
  }) });
}
